...
import car_logo from "@/assets/images/car_logo_sharetogo.png";
import {
  StyleSheet,
  Alert,
  Image,
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <Text style={styles.subtitle}>
            Podemos ayudarte a restablecer tu contraseña mediante el correo
            electrónico enlazado a tu cuenta.
          </Text>
          {errorMessage ? (
