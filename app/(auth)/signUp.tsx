...
export default function SignUp() {
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (password.length < 8 || (password.match(/\d/g) || []).length < 2) {
      setPasswordError(
        "La contrasñea debe tener como mínimo 8 carácterres y 2 dígitos"
      );
      return;
    }
    setPasswordError("");
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={styles.container}>
        ...
        >
          <Image
            source={require("../../assets/images/car_logo_sharetogo.png")}
            style={styles.image}
          />
          ...
          <View style={styles.inputRow}>
            <View style={styles.inputWrapper}>
              ...
              />
              {nameError ? (
                <Text style={styles.shortError}>{nameError}</Text>
              ) : null}
            </View>
            <View style={styles.inputWrapper}>
              <TextInput
              ...
              />
              {lastNameError ? (
                <Text style={styles.shortError}>{lastNameError}</Text>
              ) : null}
            </View>
          </View>
          <View style={styles.inputRow}>
            <View style={styles.inputWrapper}>
              ...
              />
              {phoneError ? (
                <Text style={styles.shortError}>{phoneError}</Text>
              ) : null}
            </View>
            ...
            <View style={styles.inputWrapper}>
              ...
              />
              {emailError ? (
                <Text style={styles.shortError}>{emailError}</Text>
              ) : null}
            </View>
          </View>
          ...
          {privacityError ? (
            <Text style={styles.error}>{privacityError}</Text>
          ) : null}
          <TouchableOpacity
