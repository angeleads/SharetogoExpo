...
import shareCar2_img from "@/assets/images/shareCar2_img.jpg";
import shareCar_img from "@/assets/images/shareCar_img.jpg";
import chat_img from "@/assets/images/chat_img.png";
import car_logo_text from "@/assets/images/car_logo_text.png";
...
export default function HelpPages({}) {
  ...
  const images = [shareCar_img, shareCar2_img, chat_img, car_logo_text];
    ...
    for (let i = 0; i < helpPagesNumber; i++) {
      dots.push(
        <View
          ...
          style={[
            styles.dot,
            { backgroundColor: i === currentStep ? "#2A2C38" : "#E8F6DF" },
          ]}
        />
      );
    }
      ...
      <View style={styles.circleContainer}>
        <View style={styles.whiteCircle}>
          <Image
            ...
            style={helpPagesNumber < 2 ? styles.image : styles.imageCircle}
          />
        </View>
