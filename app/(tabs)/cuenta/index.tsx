...
export default function Cuenta() {
  ...
  const updateUsersData = (userData: UserData) => {
    const { name, lastName, emailAdress, phoneNumber, profilePicture } =
      userData;
    if (
      name !== tempName ||
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.profileContainer}>
          <TouchableOpacity onPress={editor ? handleSelectImage : undefined}>
            {selectedImage ? (
              <Image
              ...
              <Image
                source={{
                  uri: "https://firebasestorage.googleapis.com/v0/b/share-to-go-db.appspot.com/o/profile_images%2FsharetoGo_greenBG.png?alt=media&token=b29e55b9-ce79-4720-be5a-d29ed46bb9e3",
                }}
                style={styles.profileImage}
              />
            )}
