...
export default function CreateTravel() {
  ...
  const publishTravel = () => {
    ...
    const isBeforeCurrentHour =
      currentDate.getHours() > selectedTime.getHours();
    const isBeforeCurrentMinutes =
      currentDate.getMinutes() > selectedTime.getMinutes();
            ...
            <View style={styles.cardContainer}>
              ...
              <View style={styles.containerRow}>
                ...
                <TextInput
                  ...
                  placeholderTextColor="#888888"
                  onChangeText={(carSeatsAvailable) =>
                    setCarSeatsAvailable(carSeatsAvailable)
                  }
