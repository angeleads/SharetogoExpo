...
export default function Reservar() {
  ...
  const sortTravelData = (data) => {
    return data
      .filter((item) =>
        moment(item.travelDate.toDate()).isSameOrAfter(moment(), "day")
      )
      .sort((a, b) => {
            ...
            {travelData.map((travel, index) => {
              ...
              return (
                <TravelCard
                  ...
                  buttonText={
                    travel.reservedTravels &&
                    travel.reservedTravels.includes(travel.id)
                      ? "Anular"
                      : "Reservar"
                  }
                  takenPlaces={
                    travel.carSeatsTaken === "" ? "0" : travel.carSeatsTaken
                  }
                  travelId={travel.id}
                  onReserve={() =>
                    handleReserveButton(
                      travel.id,
                      travel.carSeatsAvailable,
